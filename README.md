...
For a more in-depth analysis, please refer to the project [report (in Italian)](https://drive.google.com/drive/folders/1AiIUEFZuH6VNoDKyZ7C8iBzjcfA59nc8?usp=sharing).  
*(Note: as of early november 2025, the thesis has not yet been published on AMS. In the meantime, you can access it via the PDF file on my Google Drive.)*
